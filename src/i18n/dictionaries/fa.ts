...
export const fa: Dictionary = {
  ...
  showcase: {
    ...
    repoOf: "کارت مخزن",
    repoBadge: "کد",
    restrictedBadge: "غیرعمومی",
    restricted:
      "این یکی را ما ساخته‌ایم، ولی روی یک صفحه‌ی عمومی نمی‌شود بازش کرد — داده‌ای دارد که حاضر نیستیم در یک دموی عمومی بگذاریم. خوشحال می‌شویم در یک تماس نشانتان بدهیم.",
