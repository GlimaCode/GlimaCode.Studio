...
export const fa: Dictionary = {
  ...
  start: {
    ...
    note: "از طریق برنامه‌ی ایمیل شما فرستاده می‌شود — ظرف ۲۴ ساعت پاسخ می‌دهیم.",
    success: {
      openedBefore: "تیکت",
      openedAfter: "ثبت شد",
      body: "برنامه‌ی ایمیلتان باید با متن آماده باز شده باشد — فقط بفرستیدش. اگر باز نشد، مستقیم به ما ایمیل بزنید و شناسه‌ی تیکت را بنویسید.",
      again: "ثبت تیکت دیگر",
    },
  },
