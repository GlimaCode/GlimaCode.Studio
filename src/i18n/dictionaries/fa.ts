...
export const fa: Dictionary = {
  ...
  hero: {
    ...
    sub: "ما **علی** و **مصطفی** هستیم — یک استودیوی دونفره‌ی React و Supabase. هر پروژه با یک نقشه‌ی مشخص شروع می‌شود، مرحله‌مرحله تحویل داده می‌شود، و قبل از اینکه به دست شما برسد، نفر دوم کدش را بازبینی می‌کند.",
  ...
  work: {
    ...
    heading: "پروژه‌ها را همان‌طور نشان می‌دهیم که پیش می‌بریم: روی یک برد.",
    desc: "کار ما ساختن نرم‌افزار مدیریت کار است — پس نمونه‌کارها را هم در قالب طبیعی خودشان می‌بینید.",
    columns: {
      shipped: "تحویل‌شده",
  ...
  projects: {
    ...
    "PRJ-01": {
      ...
      description: "یک ممیز کیفیت داده‌ی محصول که مشکل را پیدا می‌کند و مدرکش را هم نشان می‌دهد، بدون اینکه به کاتالوگ شما دست بزند. قوانین به‌صورت داده ذخیره می‌شوند، پس عوض کردن یک قانون یک ویرایش است، نه یک نسخه‌ی جدید. صفر وابستگی، ۱۳ تست.",
    },
    "PRJ-02": {
    ...
    "PRJ-04": {
      title: "glimacode.com",
      description: "همین سایتی که در حال خواندنش هستید. React و Supabase، پورتفولیویی که از دیتابیس می‌آید، و خط درخواستی که خودمان دو نفر بررسی‌اش می‌کنیم — ساخته‌شده به‌صورت عمومی، به‌عنوان پروژه‌ی مرجع خودمان.",
    },
    "PRJ-05": {
      title: "پروژه‌ی شما",
  ...
  services: {
    ...
    items: {
      landing: {
        title: "لندینگ‌پیج",
        body: "یک لندینگ‌پیج React سریع و ریسپانسیو — تا پنج بخش، فرم تماس، سئوی پایه و انتشار روی سرور. ساخته می‌شود که بازدیدکننده را به مشتری تبدیل کند.",
      },
      dashboard: {
        title: "داشبورد ادمین",
      ...
      whitelabel: {
        ...
        body: "برای آژانس‌ها: زیر برند شما می‌سازیم. ظرفیت ساعتی یا ماهانه، ارتباط مستقیم و بی‌واسطه، و بازبینی نفر دوم روی هر چیزی که تحویلتان می‌دهیم.",
      },
    },
  },
  ...
  process: {
    ...
    steps: {
      analyze: {
        title: "تحلیل",
        body: "بریف شما را با ظرفیت و توان واقعی‌مان می‌سنجیم، بی‌تعارف. اگر گزینه‌ی درستی برایتان نباشیم، ظرف ۲۴ ساعت همین را می‌گوییم.",
      },
      kickoff: {
        title: "جلسه‌ی شروع",
        body: "قبل از نوشتن اولین خط کد، اسکوپ و زمان و قیمت مکتوب می‌شود. دقیقاً می‌دانید چه چیزی در آن هست — و چه چیزی نیست.",
      },
      build: {
        title: "ساخت مرحله‌به‌مرحله",
        body: "کار مرحله‌مرحله و قابل بررسی تحویل داده می‌شود، همراه با ویدیوی کوتاه از هر مرحله. پیشرفت را می‌بینید، نه اینکه منتظر یک رونمایی بزرگ بمانید.",
      },
      handoff: {
        title: "بازبینی و تحویل",
        body: "هر تحویلی را نفر دوم بازبینی می‌کند و بعد به دست شما می‌رسد: کد تمیز، مستندات، و انتشار روی سرور — همه مال شما.",
      },
    },
  },
  ...
  start: {
    label: "شروع پروژه",
    heading: "ثبت تیکت",
    desc: "بگویید چه می‌سازید. ظرف ۲۴ ساعت نظر بی‌تعارفمان را درباره‌ی اسکوپ، زمان و قیمت می‌گوییم.",
    ...
    fields: {
      ...
      descriptionPlaceholder:
        "چه می‌سازید؟ برای چه کسی؟ چیزی از قبل آماده دارید (طراحی، کد، نمونه)؟",
    },
    errors: {
      name: "لطفاً نام خود را وارد کنید.",
      email: "لطفاً یک ایمیل معتبر وارد کنید.",
      description: "چند جمله توضیح بدهید تا بتوانیم پاسخ مفیدی بدهیم.",
    },
    projectTypes: {
      landing: "لندینگ‌پیج",
    ...
    note: "ظرف ۲۴ ساعت پاسخ می‌دهیم.",
    throttled: "از این آدرس درخواست‌های زیادی فرستاده شده. یک ساعت دیگر امتحان کنید یا مستقیم به ما ایمیل بزنید.",
    failed: "ارسال درخواست به مشکل خورد. لطفاً مستقیم به ما ایمیل بزنید تا از دست نرود.",
    success: {
      openedBefore: "تیکت",
      openedAfter: "ثبت شد",
      body: "درخواستتان رسید. اگر قبل از پاسخ ما تماس گرفتید، همین شناسه را ذکر کنید — ظرف ۲۴ ساعت جواب می‌دهیم.",
      again: "ثبت تیکت دیگر",
    },
  },
  ...
  showcase: {
    label: "نمونه‌کارها",
    heading: "در حال اجرا ببینید",
    desc: "یک پروژه را انتخاب کنید تا روی صفحه باز شود. عکس واقعی است، نه ماکت — دقیقاً همان چیزی که ساخته شده.",
    open: "باز کردن",
    close: "بستن درب",
    openLid: "باز کردن درب",
    ...
    repoOf: "کارت مخزن",
    repoBadge: "کد",
    openRepo: "باز کردن مخزن",
    shotCount: "صفحه",
    prev: "صفحه‌ی قبل",
    next: "صفحه‌ی بعد",
    readCase: "خواندن مطالعه‌ی موردی",
    startLike: "همین را می‌خواهم",
    empty: "فعلاً چیزی برای نمایش نیست.",
  },

  portfolio: {
    label: "نمونه‌کارهای منتخب",
    heading: "کارهایی که تحویل داده‌ایم",
    desc: "یک نمونه‌ی نزدیک به آنچه لازم دارید انتخاب کنید و بریفتان را بفرستید — فرم با همان نمونه‌ی پیوست‌شده باز می‌شود.",
    all: "همه",
    empty: "هنوز چیزی اینجا منتشر نشده است.",
    ...
    fallbackNotice:
      "این پروژه هنوز ترجمه نشده، برای همین به انگلیسی نمایش داده می‌شود.",
  },
